...
const SubscriptionContractorServiceOrderPdfCard = ({ order }) => {
  return (
...
SubscriptionContractorServiceOrderPdfCard.propTypes = {
  order: PropTypes.object
};

export default SubscriptionContractorServiceOrderPdfCard;
