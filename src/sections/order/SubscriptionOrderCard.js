...
import SubscriptionEmployerServiceOrderPdfCard from 'sections/order/SubscriptionEmployerServiceOrderPdfCard';
...
const SubscriptionOrderCard = ({ order, handleApproveClick }) => {
  ...
  const handleMenuEditClick = () => {
    navigate('/orders/subscription/' + order.id);
  };
            ...
            <Stack direction="column" spacing={2}>
              <Stack direction="column" spacing={1}>
                  ...
                  {downloadingEmployerServiceOrderId == order?.id ?
                    ...
                    (
                      <IconButton sx={{ width: 22, height: 22, mr: 1.5 }} onClick={async () => {
                        ...
                        await handleDownloadPdf(<SubscriptionEmployerServiceOrderPdfCard order={order} />);
                ...
                <List component="nav" aria-label="main mailbox folders" sx={{ py: 0, '& .MuiListItem-root': { p: 0, py: 0 } }}>
                  ...
                  <ListItem>
                    <ListItemText>
                      <InfoWrapper tooltipText="subscription_order_card_company_service_order_amount_tooltip">
                        <Typography>
                          Amount
                        </Typography>
                      </InfoWrapper>
