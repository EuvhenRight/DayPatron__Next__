...
const SubscriptionEmployerServiceOrderPdfCard = ({ order }) => {
  return (
...
SubscriptionEmployerServiceOrderPdfCard.propTypes = {
  order: PropTypes.object
};

export default SubscriptionEmployerServiceOrderPdfCard;
