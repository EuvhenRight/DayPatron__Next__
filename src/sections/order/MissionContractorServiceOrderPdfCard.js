...
const MissionContractorServiceOrderPdfCard = ({ order }) => {
  return (
        ...
        <View style={styles.column}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.half}>
                <View style={styles.end}>
                  <Text style={styles.text}>{order?.contractorServiceOrder?.duration}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.half}>
                <View style={styles.end}>
                  <Text style={styles.text}>{order?.contractorServiceOrder?.rateType}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.half}>
                <View style={styles.end}>
                  <Text style={styles.text}>&euro;{order?.contractorServiceOrder?.totalAmount}</Text>
                </View>
              </View>
            </View>
...
MissionContractorServiceOrderPdfCard.propTypes = {
  order: PropTypes.object
};

export default MissionContractorServiceOrderPdfCard;
