...
const UpsertMission = ({ missionId }) => {
  ...
  const MissionSchema = Yup.object().shape({
    ...
    currentSetup: Yup.string().max(5000).nullable(true),
    whyWeNeedYou: Yup.string().max(5000).nullable(true),
    outcome: Yup.string().max(5000).nullable(true),
    profileType: Yup.string().max(5000).nullable(true),
