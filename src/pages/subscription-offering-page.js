        ...
        <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
                <MainCard>
                    ...
                    Do not forget to hit the toggle button to activate a plan. If you have an active plan and you save your subscription offering it will be published and companies will be able to subscribe to your active plans.
                </MainCard>
            </Grid>
