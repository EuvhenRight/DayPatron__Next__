...
const ContractorMissionServiceOrderPage = () => {
  ...
  const handleApproveConfirmClick = async () => {
    let response = await fetch(process.env.REACT_APP_JOBMARKET_API_BASE_URL + '/missions/orders/' + order.id + '/contractor-service-orders/contractor-approvals',
      {
        method: 'PUT',
        headers: {
          'Authorization': 'Bearer ' + keycloak.idToken,
          ...
          <MainCard>
            <List sx={{ py: 0, '& .MuiListItem-root': { p: 0, py: 0 } }}>
              ...
              <ListItem>
                ...
                <ListItemSecondaryAction>
                  {orderParam?.contractorServiceOrder?.rateType}
                </ListItemSecondaryAction>
              </ListItem>
              ...
              <ListItem>
                ...
                <ListItemSecondaryAction>
                  &euro;{orderParam?.contractorServiceOrder?.totalAmount}
                </ListItemSecondaryAction>
              </ListItem>
...
export default ContractorMissionServiceOrderPage;