              ...
              <Grid item xs zeroMinWidth>
                <Stack alignItems={matchDownSm ? 'center' : 'default'} spacing={0.5}>
                  <Stack direction={matchDownSm ? 'column' : 'row'} alignItems="center" spacing={0.5}>
                    ...
                    <Chip color="primary" variant="outlined" sx={{fontSize: '12px', height: '22px', '& .MuiChip-label': {pl: '5px', pr: '5px'}}} label={'"' + getEllipsis(missionContractorMatch?.mission?.title, 50) + '" match'} />
                  </Stack>
