			...
			<div className='group relative cursor-pointer xl:w-80 h-[600px]'>
				...
				<div className='flex flex-col items-center'>
					<Image
						...
						alt={product.name}
					/>
					<button className='group-hover:opacity-100 group-hover:-translate-y-2 opacity-100 rounded-md w-full bg-red-700 text-white py-2 px-1 transition ease-in delay-150 mt-2 xl:opacity-0 xl:-translate-y-0'>
						Докладніше
					</button>
