...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Root
		ref={ref}
		className={cn(
			'flex h-10 items-center space-x-1 rounded-md bg-transparent p-1 dark:bg-neutral-950',
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Trigger
		ref={ref}
		className={cn(
			'flex cursor-pointer select-none items-center rounded-full px-3 py-1.5 text-sm font-medium outline-none data-[state=open] data-[state=open]:text-neutral-900 dark:data-[state=open] dark:data-[state=open]:text-neutral-50',
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.SubContent
		ref={ref}
		className={cn(
			'z-50 min-w-[8rem] overflow-hidden rounded-md bg-white p-1 text-neutral-950 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 dark:bg-neutral-950 dark:text-neutral-50',
			className
		)}
		{...props}
	/>
